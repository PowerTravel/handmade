			...
			if( SoundSamples )
			{
				...
				{	
					...
					*/
						...
						r32 WorkSecondsElapsed = Win32GetSecondsElapsed(
						...
						if(SecondsElapsedForFrame<TargetSecondsPerFrame)
						{
							...
							r32 TestSecondsElapsedForFrame =  Win32GetSecondsElapsed(
