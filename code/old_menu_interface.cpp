...
menu_interface* CreateMenuInterface(memory_arena* Arena, midx MaxMemSize)
{
...
#endif
  {
    ...
    PushEmptyWindow(menu_interface* Interface,  container_node* Parent, v4 Color )
    
    container_node* EmptyBody = NewContainer(Interface, container_type::Empty);
     
    GetContainerPayload(empty_window, Node)->Color = V4(0.2,0.4,0.2,1);
